...
<div className={`flex items-center justify-center gap-2 max-lg:flex-col max-lg:absolute max-lg:top-[80px] max-lg:left-0 max-lg:w-full bg-white pb-2 ${menuOpen ? 'max-lg:translate-y-0' : 'max-lg:translate-y-full'}`}>
